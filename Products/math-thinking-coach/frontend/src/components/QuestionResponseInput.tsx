...
// dedicated component (every type except single_choice today), which is
// what already keeps every existing question working unchanged: legacy
// questions never carry a questionType other than "short_text"/"numeric",
// both of which resolve here.
